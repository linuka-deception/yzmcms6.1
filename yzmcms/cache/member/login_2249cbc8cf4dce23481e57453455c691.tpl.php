...
<html>
  ...
  <body>
				...
				<form action="" method="post">
					...
					<ul>
					 ...
					 <li><input type="password" class="input"  name="password" id="password" placeholder="请输入密码" required  value=""></li>
	 				 ...
	 				 <li><input type="text" class="input code" required name="code" placeholder="请输入验证码"><img src="<?php echo U('api/index/code');?>" onclick="this.src=this.src+'?'" class="codeimg" title="看不清，换一张"></li>	
	                 <?php } ?>
		...
		<div class="yzm_footer">
			<div class="container">
				<p>Powered by <a href="http://www.yzmcms.com" target="_blank"><?php echo YZMCMS_SOFTNAME;?></a> © 2014-2021  版权所有</p>
			</div>
		</div>
  </body>
</html>